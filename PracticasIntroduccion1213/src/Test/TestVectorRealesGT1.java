...
public class TestVectorRealesGT1 extends TestCase {
	...
	public void testVectorReales() {
		...
		System.out.println("V4 antes de invertir = " + v4);
		v5 = v4.invertirClone();
		System.out.println("V4 despues de invertir = " + v4);
		System.out.println("V5 = " + v5);
		assertEquals(v4,new VectorReales(1.0,2.0,3.0,4.0));
		assertEquals(v5,new VectorReales(4.0,3.0,2.0,1.0));
